...
final class IncreaseProductQuantityHandler
{
    ...
    public function handle(IncreaseProductQuantityCommand $command): Cart
    {
        ...
        $cart->increaseProductQuantity($product, $command->getQuantity());
